...
import { 
  FaLinkedinIn, FaFacebookF, FaTwitter, FaYoutube, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-blue-100/70 text-sm leading-relaxed">
              Empowering businesses through strategic consultancy, industry-standard certifications, and compliance excellence. Your growth is our mission.
            </p>
          ...
          <div>
            <h4 className="text-[#997819] font-black uppercase tracking-widest text-sm mb-8">Certifications</h4>
            <ul className="space-y-4 text-sm">
              {["SIA ACS Support", "ISO 9001 Quality", "ISO 14001 Environment", "Cyber Essentials", "SafeContractor"].map((service) => (
                <li key={service} className="text-blue-100/70 hover:text-white transition-colors cursor-pointer">
                  {service}
                </li>
              ))}
            </ul>
          ...
          <div>
            <h4 className="text-[#997819] font-black uppercase tracking-widest text-sm mb-8">Get In Touch</h4>
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-xs text-[#997819] font-bold uppercase">Call Us</p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-xs text-[#997819] font-bold uppercase">Email</p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-xs text-[#997819] font-bold uppercase">Location</p>
                  <p className="text-sm italic">CEME Campus, Marsh Way, RM13 8EU</p>
                </div>
              </div>
            </div>
          </div>
