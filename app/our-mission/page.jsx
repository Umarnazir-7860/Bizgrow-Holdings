...
const MissionPage = () => {
  return (
    <main className="bg-white text-zinc-900">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <FadeIn direction="right">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-[#12066a] leading-tight mt-1 tracking-tighter italic">
                All-in-One Business Solutions for Security Companies
              </h3>
            </FadeIn>

            <FadeIn direction="right" delay={0.2}>
              <p className="text-black text-lg -mt-4 leading-relaxed font-medium">
                ...
                development, or digital solutions, we ensure every step supports
                your business success. Our approach is practical: We give you
                the tools, the training, and the systems that you need to
                strengthen your business, improve efficiency, and stay aligned
                with SIA and industry standards. <br />{" "}
                <b className="mt-2">We help security businesses to:</b>
              </p>
            </FadeIn>
            ...
            <p>
              ...
              <b className="mt-2"> BizGrow Holdings</b>, your business is always
              on the right path, compliant, efficient, and ready to grow.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-22 bg-zinc-50 border-y border-zinc-200">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn direction="up">
            <div className="text-center mb-24">
              ...
              <h3 className="text-4xl md:text-6xl font-black text-[#12066a] tracking-tight">
