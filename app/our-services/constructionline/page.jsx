          ...
          <div className="max-w-7xl  mb-16">
            <FadeIn direction="up">
              ...
              <div className="text-center max-w-7xl mx-auto mb-16">
                ...
                <p className="text-zinc-600 mx-30 text-lg  font-medium leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            <div className="lg:w-1/2">
              ...
              <h2 className="text-5xl md:text-6xl font-black text-[#12066a] tracking-tighter leading-none ">
                Reasons to Choose
                <span className="text-[#997819]"> Constructionline</span>
              </h2>
              <p className="py-4">
              ...
              <p className="font-bold text-2xl py-2 text-black">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="relative">
              ...
              <div className="space-y-10 relative">
                ...
                {/* --- SECTION: CONTRACTORS --- */}
                <div className="mb-14">
                  <h3 className="text-[#997819] font-black text-sm uppercase tracking-[0.3em] my-4 ml-20">
                    For Contractors
                  </h3>
                  {[
