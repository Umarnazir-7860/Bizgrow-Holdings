          ...
          <div className="bg-[#12066a] p-12 md:p-32 rounded-[4rem] text-center text-white relative overflow-hidden group shadow-2xl">
            ...
            <div className="absolute inset-0 z-0 opacity-40 group-hover:scale-110 transition-transform duration-1000">
              <Image
                ...
                alt="Connect with UK SIA ACS compliance consultants"
                fill
                className="object-cover"
              />
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                <button className="px-12 py-6 bg-[#997819] text-white font-black uppercase tracking-widest text-sm rounded-2xl hover:bg-white hover:text-[#12066a] transition-all duration-500 shadow-2xl">
                  Book a Strategic ACS Consultation
                </button>
              </div>
            </div>
          </div>
