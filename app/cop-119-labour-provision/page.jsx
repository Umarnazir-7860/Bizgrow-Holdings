      ...
      <section className="py-32 bg-[#12066a] text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <FadeIn direction="up">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4  text-[#997819]">
            ...
            {[
              ...
              <FadeIn key={i} direction="up" delay={i * 0.2}>
                <div className="p-10 border border-white/10 bg-white rounded-[3rem] hover:bg-white hover:text-[#12066a] transition-all  duration-700 group">
                  <div className="text-[#997819] mb-8 group-hover:scale-110 transition-transform">
                    {pillar.icon}
                  </div>
                  <h3 className="text-2xl text-[#12066a] font-black mb-4 tracking-tight">
                    {pillar.t}
                  </h3>
                  <p className="text-zinc-600 group-hover:text-zinc-500 font-medium leading-relaxed">
                    {pillar.d}
                  </p>
                </div>
              </FadeIn>
